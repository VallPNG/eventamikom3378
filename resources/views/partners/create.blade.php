...
<div class="max-w-3xl mx-auto px-6 py-10">
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-8">
        <form action="{{ route('admin.partners.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="logo" class="block text-sm font-bold text-slate-700 mb-2">Upload Logo (Opsional)</label>
                ...
                <p class="mt-2 text-sm text-slate-500">Format yang didukung: JPG, PNG, WEBP (Maks: 2MB).</p>
            </div>
